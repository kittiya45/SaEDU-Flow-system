...
var STTH={draft:'ร่างเอกสาร',pending:'รอลงนาม',signed:'ลงนามแล้ว',rejected:'ส่งคืนแก้ไข',numbering:'รอออกเลขหนังสือ',awaiting_submit:'รอเจ้าหน้าที่ยื่นในระบบ',completed:'เสร็จสมบูรณ์',cancelled:'ยกเลิกแล้ว'};
/* สถานะที่ยกเลิกเอกสารได้ — ทุกสถานะยกเว้น cancelled (ยกเลิกไปแล้ว)
   ไม่มีปัญหาเรื่องลำดับเลขหนังสือขาด เพราะ doCancelDoc() ไม่ได้ล้าง doc_number ทิ้ง
   เอกสารที่ยกเลิกยังถือเลขเดิมไว้ _nextDocNum() จึงเดินต่อจากเลขสูงสุดได้ตามปกติ
   แต่ completed/awaiting_submit ยื่นเข้าคณะไปแล้ว ต้องเตือนเป็นพิเศษว่าการกดที่นี่
   ไม่ได้ดึงเอกสารกลับจากคณะ (ดู POSTED_ST + คำเตือนใน showCancelDocModal) */
var CANCELLABLE_ST=['draft','pending','rejected','numbering','completed','awaiting_submit'];
/* สถานะที่เอกสารถูกส่งออกนอกระบบไปแล้ว — ต้องเตือนแรงกว่าปกติตอนยกเลิก */
var POSTED_ST=['completed','awaiting_submit'];
