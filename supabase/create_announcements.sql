-- ═══════════════════════════════════════════════════════════════════
-- create_announcements.sql — บอร์ดประกาศหน้า Home (แดชบอร์ด)
--
...
-- แสดงเป็นการ์ด "ประกาศ" บนหน้าภาพรวมของทุกคนที่ล็อกอิน (dashboard.js)
...
-- (is_dev() มาจาก create_dev_role.sql — ต้องรันไฟล์นั้นก่อนไฟล์นี้)
